...
pub fn is_positive_preliminary(reply: u32) -> bool {
    reply >= 100 && reply < 200
}

pub fn is_positive_completion(reply: u32) -> bool {
    reply >= 200 && reply < 300
}

pub fn is_positive_intermediate(reply: u32) -> bool {
    reply >= 300 && reply < 400
}

pub fn is_negative_transient(reply: u32) -> bool {
    reply >= 400 && reply < 500
}

pub fn is_negative_permanent(reply: u32) -> bool {
    reply >= 500 && reply < 600
}

pub fn is_protected_reply_code(reply: u32) -> bool {
    reply >= 600 && reply < 700
}